    ...
    <header className="sticky top-0 z-40 flex h-16 shrink-0 items-center justify-between border-b border-slate-200 bg-white px-4 shadow-sm sm:px-6">
      <div className="flex items-center gap-6">
        ...
        <div className="hidden items-center gap-3 text-sm font-medium md:flex">
          ...
          <div className="flex items-center gap-1.5 rounded-full border border-slate-200 bg-slate-100 px-2.5 py-1 text-slate-600">
            <User className="h-3.5 w-3.5" />
            {learnerLabel}
          </div>
          <div className="flex items-center gap-1.5 rounded-full border border-indigo-100 bg-indigo-50 px-2.5 py-1 text-indigo-700">
